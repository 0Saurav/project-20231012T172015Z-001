...
if (isset($_POST['add_product'])) {
   ...
   $price = $_POST['price'];
   $stock = $_POST['stock']; // Added to get the initial stock level
...
if (isset($_POST['update_product'])) {
   ...
   $update_stock = $_POST['update_stock']; // Get the updated stock level
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" name="stock" class="box" placeholder="Enter initial stock" required>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="stock">Stock: <?php echo $fetch_products['stock']; ?></div> <!-- Display stock level -->
...
<section class="edit-product-form">
   ...
   ?>
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <input type="number" name="update_stock" value="<?php echo $fetch_update['stock']; ?>" min="0" class="box" required placeholder="Enter stock level">
