...
if(isset($_POST['add_to_cart'])){
   ...
   $check_stock_query = mysqli_query($conn, "SELECT stock FROM `products` WHERE name = '$product_name'") or die('query failed');
   if(mysqli_num_rows($check_stock_query) > 0){
      $fetch_stock = mysqli_fetch_assoc($check_stock_query);
      $available_stock = $fetch_stock['stock'];

      if ($product_quantity > $available_stock) {
         $message[] = 'Sorry, not enough stock available for ' . $product_name;
      } else {
...
<section class="about">
   ...
   <div style="background-color: 0000; padding: 25px; border-radius: 50%; overflow: hidden;">
  <img src="images/about-img.jpg" alt="about us" style="max-width: 100%; height: auto; opacity: 0.7; background-color: white;">
      ...
      <div class="content">
         <h3>about us</h3>
         <p>We are Pustak</p>
         <p>Discovering worlds, one page at a time - your gateway to literary adventures and trusted book recommendations</p>
...
<section class="home-contact">
   ...
   <div class="content">
      ...
      <p>Have questions or need assistance? Contact us today; we're here to help!</p>
